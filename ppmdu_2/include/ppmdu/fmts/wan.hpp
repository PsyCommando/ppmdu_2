    ...
    struct wan_img_data_info
    {
        ...
        */
        ...
        void FillFromSprite( pmd2::graphics::BaseSprite * sprite )
        {
            ...
            assert(sprite->getNbFrames() < std::numeric_limits<uint16_t>::max());
            nbImgsTblPtr           = static_cast<uint16_t>(sprite->getNbFrames());
        }
    };
    ...
    **********************************************************************/
    struct wan_anim_info
    {
        ...
        */
        ...
        void FillFromSprite( pmd2::graphics::BaseSprite * sprite )
        {
            assert(sprite->getAnimGroups().size() < std::numeric_limits<uint16_t>::max());
            nb_anim_groups = static_cast<uint16_t>(sprite->getAnimGroups().size());
