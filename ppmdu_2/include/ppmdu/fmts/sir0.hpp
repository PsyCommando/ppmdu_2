    ...
    ***************************************************************************/
    ...
    public:
            ...
            void Write( _backinsoutit & itw )
        {
            ...
            hdr.ptrPtrOffsetLst = static_cast<uint32_t>(m_data.size()) + sir0_header::HEADER_LEN;
            ...
            //Pad as needed
            const size_t nbpadbytes = utils::AppendPaddingBytes( itw, m_data.size() + sir0_header::HEADER_LEN, 16, 0xAA );
            ...
            //Put final padding!
            utils::AppendPaddingBytes( itw, encoded.size() + nbpadbytes +  m_data.size() + static_cast<size_t>(sir0_header::HEADER_LEN), 16, 0xAA );
        }
        ...
        */
        ...
        {
            pushptroffset(static_cast<uint32_t>(m_data.size()) + sir0_header::HEADER_LEN);
