...
//==================================================================
    ...
    const utils::Resolution RES_INVALID      = {  0,  0 };

    //Legal resolutions for sprites
    const utils::Resolution RES_8x8_SPRITE   = {  8,  8 };
    const utils::Resolution RES_16x16_SPRITE = { 16, 16 };
    const utils::Resolution RES_32x32_SPRITE = { 32, 32 };
    const utils::Resolution RES_64x64_SPRITE = { 64, 64 };
    const utils::Resolution RES_8x16_SPRITE  = {  8, 16 }; 
    const utils::Resolution RES_16x8_SPRITE  = { 16,  8 }; 
    const utils::Resolution RES_32x8_SPRITE  = { 32,  8 };
    const utils::Resolution RES_8x32_SPRITE  = {  8, 32 };
    const utils::Resolution RES_32x16_SPRITE = { 32, 16 };
    const utils::Resolution RES_16x32_SPRITE = { 16, 32 };
    const utils::Resolution RES_64x32_SPRITE = { 64, 32 };
    const utils::Resolution RES_32x64_SPRITE = { 32, 64 };

    //Legal resolutions for portraits
    const utils::Resolution RES_PORTRAIT     = { 40, 40 };
