...
//=========================================================================================
    ...
    */
    ...
    //-----------------------------
        ...
        // --- References handling ---
        inline unsigned int       getNbRefs()const                  { return static_cast<unsigned int>(m_animFrmsRefer.size()); }
...
//=========================================================================================
    ...
    */
    ...
    public:
        ...
        inline unsigned int        getNbFrames()const                  { return static_cast<unsigned int>(m_frames.size()); } //Not counting the obligatory closing null frame!!
        ...
        uint32_t insertFrame( AnimFrame && aframe, int index = -1 ) //Inserts a frame. If index == -1, inserts at the end! Return index of frame!
        {
            ...
            else
            {
                ...
                insertpos = (static_cast<uint32_t>(m_frames.size()) - 1u);
            }
            return insertpos;
        }
