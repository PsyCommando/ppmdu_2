    ...
    *************************************************************************************************/
    ...
    public:
        ...
        inline void setNbTilesRowsAndColumns( unsigned int nbcols, unsigned int nbrows )
        {
            ...
            unsigned int rowwidth = (!m_tiles.empty())? static_cast<unsigned int>(m_tiles.front().size()) : 0u;
...
//=============================================================================
    ...
    *************************************************************************************************/
    ...
    public:
        ...
        inline const pal_color_t              & getColor( typename _parentty::pixel_t::pixeldata_t index )const { return m_palette[index]; }
        inline pal_color_t                    & getColor( typename _parentty::pixel_t::pixeldata_t index )      { return m_palette[index]; }
        inline unsigned int                     getNbColors()const                                   { return static_cast<unsigned int>(m_palette.size()); }
        inline void                             setNbColors(unsigned int nbcol)                      { return m_palette.resize(nbcol); }
        inline void setColor( typename _parentty::pixel_t::pixeldata_t index, pal_color_t && color )            { m_palette[index] = color; }
        inline void setColor( typename _parentty::pixel_t::pixeldata_t index, pal_color_t color )               { m_palette[index] = std::move(color); }
