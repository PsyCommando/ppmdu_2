...
*************************************************************************************************************/
    class RAII_WriteListChunk
    {
        ...
        std::ofstream::pos_type         m_prewrite;
    ...
    public:
        ...
        ~RAII_WriteListChunk()
        {
            ...
            //Save Post-write pos
            const std::ofstream::pos_type postwrite = m_pout->tellp();
...
*************************************************************************************************************/
    class RAII_WriteChunk
    {
        eSF2Tags                        m_tag;
        std::ofstream                 * m_pout;
        std::ofstream::pos_type         m_prewritepos;
        std::ostreambuf_iterator<char>  m_itout;
        size_t                        * m_onbbyteswritten;
...
//=========================================================================================
    ...
    {
        typedef std::function<std::ofstream::pos_type()> listmethodfun_t;
    public:
        ...
        std::ofstream Write( std::ofstream && output )
        {
            ...
            const std::ofstream::pos_type prewriteoffset = m_out.tellp();
            ...
            std::ofstream::pos_type datasz    = 4; //Count the 4 bytes of the fmt tag
    ...
    private:
        ...
        inline std::ofstream::pos_type GetCurTotalNbByWritten()
        {
    ...
    //----------------------------------------------------------------
        ...
        ofstream::pos_type WriteInfoList()
        {
            //Save pre-write pos
            const std::ofstream::pos_type prewrite = m_out.tellp();
    ...
    //----------------------------------------------------------------
        ...
        ofstream::pos_type WriteSdataList()
        {
            const std::ofstream::pos_type prewrite = GetCurTotalNbByWritten();
        ...
        ofstream::pos_type WriteSmplChunk()
        {
            const std::ofstream::pos_type prewrite = GetCurTotalNbByWritten();
...
//#endif
    ...
    //----------------------------------------------------------------
        ...
        ofstream::pos_type WritePdataList()
        {
            const std::ofstream::pos_type prewrite = GetCurTotalNbByWritten();
        ...
        ofstream::pos_type WriteHYDRAPresets()
        {
            const std::ofstream::pos_type prewrite = GetCurTotalNbByWritten();
        ...
        ofstream::pos_type WriteHYDRAInstruments()
        {
            const std::ofstream::pos_type prewrite = GetCurTotalNbByWritten();
        ...
        ofstream::pos_type WriteHYDRASampleHeaders()
        {
            const std::ofstream::pos_type prewrite = GetCurTotalNbByWritten();
            ostreambuf_iterator<char>      itout(m_out);
            ...
            for( size_t i = 0; i < m_sf.GetNbSamples(); ++i )
            {
                ...
                const size_t charstocopy = std::min( smpl.GetName().size(), static_cast<size_t>(ShortNameLen-1) ); 
    ...
    //  Presets
    //-----------------------------
        ofstream::pos_type WritePHDRChunk()
        {
            const std::ofstream::pos_type prewrite = GetCurTotalNbByWritten();
            ostreambuf_iterator<char>      itout(m_out);
            ...
            for( size_t i = 0; i < m_sf.GetNbPresets(); ++i )
            {
                ...
                const size_t charstocopy = std::min( preset.GetName().size(), static_cast<size_t>(ShortNameLen-1) ); 
                const size_t charstozero = ShortNameLen - charstocopy;                          //Nb of zeros to append
        ...
        ofstream::pos_type WritePBagChunk()
        {
            const std::ofstream::pos_type  prewrite = GetCurTotalNbByWritten();
            ostreambuf_iterator<char>      itout(m_out);
            uint16_t                       pgenndx = 0;
        ...
        ofstream::pos_type WritePModChunk()
        {
            const std::ofstream::pos_type  prewrite = GetCurTotalNbByWritten();
            ostreambuf_iterator<char>      itout(m_out);
        ...
        ofstream::pos_type WritePGenChunk()
        {
            const std::ofstream::pos_type prewrite = GetCurTotalNbByWritten();
            ostreambuf_iterator<char>     itout(m_out);
    ...
    //  Instruments
    //-----------------------------
        ofstream::pos_type WriteInstChunk()
        {
            const std::ofstream::pos_type  prewrite = GetCurTotalNbByWritten();
            ostreambuf_iterator<char>      itout(m_out);
            ...
            for( size_t cntinst = 0; cntinst < m_sf.GetNbInstruments(); ++cntinst )
            {
                ...
                const size_t charstocopy = std::min( curinst.GetName().size(), static_cast<size_t>(ShortNameLen-1) ); 
                const size_t charstozero = ShortNameLen - charstocopy;                          //Nb of zeros to append
        ...
        ofstream::pos_type WriteIBagChunk()
        {
            const std::ofstream::pos_type  prewrite = GetCurTotalNbByWritten();
            ostreambuf_iterator<char>      itout(m_out);
            uint16_t                       igenndx = 0;
        ...
        ofstream::pos_type WriteIModChunk()
        {
            const std::ofstream::pos_type  prewrite = GetCurTotalNbByWritten();
            ostreambuf_iterator<char>      itout(m_out);
        ...
        ofstream::pos_type WriteIGenChunk()
        {
            const std::ofstream::pos_type prewrite = GetCurTotalNbByWritten();
            ostreambuf_iterator<char>     itout(m_out);
    ...
    private:
        ...
        std::ofstream             m_out;
        std::ofstream::pos_type   m_prewrite; //The position in the stream before we began writing the entire Soundfont

        //Keep track of where the samples where written, from the beginning of the sounfont structure
        std::vector<std::pair<std::ofstream::pos_type,std::ofstream::pos_type>>   m_smplswritepos;
