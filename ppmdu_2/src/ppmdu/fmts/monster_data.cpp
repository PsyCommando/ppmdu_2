...
//==========================================================================================
    ...
    public:
        ...
        {
            uint32_t filelength = ( monstermd_header::HEADER_LEN + (static_cast<uint32_t>(m_Pkmns.size()) * PokeMonsterData::DataLen) );
    ...
    private:
        ...
        void WriteHeader()
        {
            ...
            hdr.nbentries = static_cast<uint32_t>(m_Pkmns.size());
